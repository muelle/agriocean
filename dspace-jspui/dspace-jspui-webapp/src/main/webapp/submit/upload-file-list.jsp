...
<dspace:layout locbar="off" navbar="off" titlekey="jsp.submit.upload-file-list.title">
    ...
    <form id="mainForm" action="<%= request.getContextPath()%>/submit" method="post" onkeydown="return disableEnterKey(event);" onsubmit="CCLicense();">
        ...
        <%    }
        %>
        <div><fmt:message key="jsp.submit.upload-file-list.info2"/>&nbsp;&nbsp;&nbsp;<dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, 
        ...
        <ul class="uploadHelp">
            ...
            <li class="uploadHelp"><fmt:message key="jsp.submit.upload-file-list.info5"/>
                ...
                \"help.index\") + \"#checksum\"%>"><fmt:message key="jsp.submit.upload-file-list.help1"/></dspace:popup></li>
                <%
                        }
                        else
                        {
            ...
            <li class="uploadHelp"><fmt:message key="jsp.submit.upload-file-list.info6"/>
                ...
                \"help.index\") + \"#checksum\"%>"><fmt:message key="jsp.submit.upload-file-list.help2"/></dspace:popup> <input type="submit" name="submit_show_checksums" value="<fmt:message key="jsp.submit.upload-file-list.button3"/>" /></li>
                <%
                        }
                %>
        </ul>
