...
/**
 * Dublin Core date utility class <P> Dates in the DSpace database are held in
 * the ISO 8601 format. They are always stored in UTC, converting to and from
 * the current time zone. In practice only dates with a time component need to
 * be converted. <P>
 * <code>YYYY-MM-DDThh:mm:ss</code> <P> There are four levels of granularity,
 * depending on how much date information is available: year, month, day, time.
 * <P> Examples:
 * <code>1994-05-03T15:30:24</code>,
 * <code>1995-10-04</code>,
 * <code>2001-10</code>,
 * <code>1975</code>
 *
...
public class DCDate {
    ...
    /**
     * Construct a date object from a bunch of component parts. The date passed
     * in is assumed to be in the current time zone. Unknown values should be
     * given as -1.
     *
     * @param yyyy the year
     * @param mm the month
    ...
    /**
     * Set all the formatters to use UTC. SimpleDateFormat is not thread-safe
     * which is why they are not static variables initialised once.
     */
    ...
    /**
     * Get the date as a string to put back in the Dublin Core. Use the UTC/GMT
     * calendar version.
     *
    ...
    /**
     * Format a human-readable version of the DCDate, with optional time. This
     * needs to be in DCDate because it depends on the granularity of the
     * original time.
     *
