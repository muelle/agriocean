...
public abstract class AbstractDSpaceObjectTest extends AbstractUnitTest {
    ...
    public void testFind() throws SQLException {
        if (this.dspaceObject instanceof Bitstream) {
            assertThat("BITSTREAM type", DSpaceObject.find(context, Constants.BITSTREAM, dspaceObject.getID()),
                       notNullValue());
        } else if (this.dspaceObject instanceof Bundle) {
            assertThat("BUNDLE type", DSpaceObject.find(context, Constants.BUNDLE, dspaceObject.getID()),
                       notNullValue());
        } else if (this.dspaceObject instanceof Item) {
            assertThat("ITEM type", DSpaceObject.find(context, Constants.ITEM, dspaceObject.getID()), notNullValue());
        } else if (this.dspaceObject instanceof Collection) {
            assertThat("COLLECTION type", DSpaceObject.find(context, Constants.COLLECTION, dspaceObject.getID()),
                       notNullValue());
        } else if (this.dspaceObject instanceof Community) {
            assertThat("COMMUNITY type", DSpaceObject.find(context, Constants.COMMUNITY, dspaceObject.getID()),
                       notNullValue());
        } else if (this.dspaceObject instanceof Group) {
            assertThat("GROUP type", DSpaceObject.find(context, Constants.GROUP, dspaceObject.getID()), notNullValue());
        } else if (this.dspaceObject instanceof EPerson) {
            assertThat("EPERSON type", DSpaceObject.find(context, Constants.EPERSON, dspaceObject.getID()),
                       notNullValue());
        } else if (this.dspaceObject instanceof Site) {
            assertThat("SITE type", DSpaceObject.find(context, Constants.SITE, dspaceObject.getID()), notNullValue());
        } else {
            assertThat("Unknown type", DSpaceObject.find(context, -99, 1), nullValue());
        }
    }
    ...
    public void testGetAdminObject() throws SQLException {
        ...
        assertThat("WORKFLOW_STEP_1 action", dspaceObject.getAdminObject(Constants.WORKFLOW_STEP_1),
                   is(equalTo(dspaceObject)));
        assertThat("WORKFLOW_STEP_2 action", dspaceObject.getAdminObject(Constants.WORKFLOW_STEP_2),
                   is(equalTo(dspaceObject)));
        assertThat("WORKFLOW_STEP_3 action", dspaceObject.getAdminObject(Constants.WORKFLOW_STEP_3),
                   is(equalTo(dspaceObject)));
        assertThat("WORKFLOW_ABORT action", dspaceObject.getAdminObject(Constants.WORKFLOW_ABORT),
                   is(equalTo(dspaceObject)));
        assertThat("DEFAULT_BITSTREAM_READ action", dspaceObject.getAdminObject(Constants.DEFAULT_BITSTREAM_READ),
                   is(equalTo(dspaceObject)));
        assertThat("DEFAULT_ITEM_READ action", dspaceObject.getAdminObject(Constants.DEFAULT_ITEM_READ),
                   is(equalTo(dspaceObject)));
    }
    ...
    public void testGetAdminObjectwithException() throws SQLException {
        if ((this.dspaceObject instanceof Bundle) || (this.dspaceObject instanceof Community)
                || (this.dspaceObject instanceof Collection) || (this.dspaceObject instanceof Item)) {
