...
<%
            ...
            // Added by Dimitri Surinx START
            //boolean sideBar = true;//ConfigurationManager.getBooleanProperty("webui.rightsidebar");
            // Added by Dimitri Surinx END
    ...
    <table class="miscTable" align="center" summary="This table allows you to search through all communities held in the repository">
        ...
        <tr>
            <td align="center" class="standard" valign="middle">
                <div> <small><fmt:message key="jsp.general.orbrowse"/>&nbsp;</small></div>
    ...
    <ul class="collectionListItem">
        ...
        <li>
            <table>
                ...
                <tr>
                    <td>
                        <%out.println(collections[i].getMetadata("short_description"));%>
    ...
    <%-- display the overview page --%>
        ...
        <center>
            ...
            <a href="<%= request.getContextPath()%>/feed/<%= fmts[j]%>/<%= community.getHandle()%>">
                <img src="<%= request.getContextPath()%>/image/<%= icon%>" alt="RSS Feed" vspace="3" border="0" />
            </a>
                <%
                        }
                %>
