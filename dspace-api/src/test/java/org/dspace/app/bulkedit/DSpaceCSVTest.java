...
public class DSpaceCSVTest extends AbstractUnitTest {
    ...
    public void testDSpaceCSV() {
        try {
            ...
            String[] csv = {
                "id,collection,\"dc.title[en]\",dc.contributor.author,dc.description.abstract",
            ...
            assertThat("testDSpaceCSV New lines", line.valueToCSV(value), equalTo("\"Abstract with\ntwo\nnew lines\""));
            ...
            try {
                ...
                assertThat("testDSpaceCSV Bad heading CSV", e.getMessage(),
                           equalTo("Unknown metadata element in heading: dc.contributor.foobar"));
            }
            ...
            try {
                ...
                assertThat("testDSpaceCSV Bad heading CSV", e.getMessage(),
                           equalTo("Unknown metadata schema in heading: dcdc.title"));
            }
